...
const TopVillas = () => {
  return (
    <section id="topVillas">
      ...
      <p>
        Discover our handpicked selection of luxury villas, designed for
        comfort, privacy, and unforgettable stays. Whether you're planning a
        family holiday, group getaway, or a relaxing retreat, these villas offer
        premium amenities, spacious interiors, and stunning locations.
      </p>
